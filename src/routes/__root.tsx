  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <p className="eyebrow text-gold">The Splendid Sanctuary</p>
        <h1 className="mt-4 font-display text-6xl text-foreground">404</h1>
        <h2 className="mt-3 text-lg font-medium text-foreground">This page has checked out</h2>
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md bg-primary px-5 py-2.5 text-xs tracking-[0.18em] text-primary-foreground uppercase transition-colors hover:bg-primary/90"
          >
            Return home
          </Link>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "The Splendid Sanctuary — Luxury Hotel & Retreat" },
      {
        name: "description",
        content:
          "Refined accommodation, exceptional dining and unforgettable leisure at The Splendid Sanctuary. Where luxury meets tranquility.",
      },
      { name: "author", content: "The Splendid Sanctuary" },
      { property: "og:title", content: "The Splendid Sanctuary — Where Luxury Meets Tranquility" },
      {
        property: "og:description",
        content: "A luxury hotel designed around comfort, connection and unforgettable moments.",
      },
